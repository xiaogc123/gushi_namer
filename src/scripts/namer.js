...
class Namer {
  ...
  cleanBadChar(str) {
    const badChars = '马牛兔羊鸭鹅偷抢劫摸魔播驳薄磨鸦恶鸟尿掉吊叼屌逼鼻屄毙毙鄙死尸屎湿奸淫禁阴淫婬屁癖痞蜱甩摔坏衰输熟恕奴抽丑臭愁仇臭凑揍走粥咒毁霉灭蔑指只胸鬼懒禽鸟鸡我邪罪凶丑仇鼠蟋蟀淫秽妹狐鸡鸭蝇悔鱼肉苦犬吠窥血丧饥女搔父母昏狗蟊疾病痛死潦哀痒害蛇牲妇狸鹅穴畜烂兽靡爪氓劫鬣螽毛婚姻匪婆羞辱'.split('');
